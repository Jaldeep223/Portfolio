...
function runMatter() {
  ...
  var attractiveBody = Bodies.circle(
    render.options.width / 2,
    render.options.height / 2,
    Math.max(dimensions.width / 8, dimensions.height / 8),  // increased size here
    {
      render: {
        fillStyle: `#000`,
        strokeStyle: `#000`,
  ...
  for (var i = 0; i < 60; i += 1) {
    let x = Common.random(0, render.options.width)
    let y = Common.random(0, render.options.height)
    let s = Common.random() > 0.6 ? Common.random(60, 120) : Common.random(40, 100) // increased polygon size
    let poligonNumber = Common.random(3, 6)
    var body = Bodies.polygon(
      x,
      y,
    ...
    let r = Common.random(0, 1)
    var circle = Bodies.circle(x, y, Common.random(10, 30), {  // increased radius
      mass: 0.1,
      friction: 0,
      frictionAir: 0.01,
      render: {
    ...
    var circle = Bodies.circle(x, y, Common.random(15, 50), {  // increased radius
      mass: 6,
      friction: 0,
      frictionAir: 0,
      render: {
    ...
    var circle = Bodies.circle(x, y, Common.random(20, 70), {  // increased radius
      mass: 0.2,
      friction: 0.6,
      frictionAir: 0.8,
      render: {
